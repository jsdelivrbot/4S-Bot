{
    ...
    "isopen": "/me Rulet je poceo. Ukucaj !udji da udjes!",
    "winnerpicked": "/me Pobednik je izabran! @%%NAME%% na poziciju %%POSITION%%.",
    ...
    "invalidtime": "/me [@%%NAME%%] Netacno vreme.",
    ...
    "autowoot": "/me instaliraj PlugCubed za autowooting: http://plugcubed.net/",
    ...
    "chatcleared": "/me [@%%NAME%%] je ocistio chat.",
    "deletechat": "/me [@%%NAME%%] Cleared the chat of %%USERNAME%%.",
    "commandslink": "/me Komande: %%LINK%%",
    ...
    "facebook": "/me Fb stranica: %%LINK%%",
    "starterhelp": "/me Ovo ti moze pomoci: %%LINK%%",
    "roulettejoin": "/me @%%NAME%% je usao na rulet! (!izadji da izadjes)",
    "jointime": "/me [@%%NAMEFROM%%] @%%USERNAME%% has been in the room for %%TIME%%.",
    "kickrank": "/me [@%%NAME%%] Nemos kikovati nekoga ko ma veci rank od tebe!",
    "kick": "/me [@%%NAME%%], @%%USERNAME%% Kikovan si %%TIME%% minuta.",
    "kill": "/me Shutting down.",
    "rouletteleave": "/me @%%NAME%% izasao sa ruleta!",
    "songlink": "/me [@%%NAME%%] Link od pesme: %%LINK%%",
    ...
    "mutednotime": "/me [@%%NAME%%] Mutovo @%%USERNAME%%.",
    ...
    "swapping": "/me Menjam %%NAME1%% sa %%NAME2%%.",
    "genres": "/me Please find the permissible room genres here: %%LINK%%",
    "notbanned": "/me [@%%NAME%%] Nije bio banovan.",
    "unmutedeveryone": "/me [@%%NAME%%] Unmutovo sve.",
    "unmuteeveryonerank": "/me [@%%NAME%%] Only managers and up can unmute everyone at once.",
    "notmuted": "/me [@%%NAME%%] Nije bio mutovan.",
