...
X specifican broj
argument izmedju ( ) je neobavezan
...
|!ocistichat | |obrisi chat |
|!cycle | | toggle DJ cycle |
|!cycletimer | X | set the maximum DJ cycle time for when cycleguard is enabled |
|!locktimer | X | set the maximum time the waitlist can be locked if lockguard is enabled |
|!osvezi | | refreshes the browser of whoever runs the bot |
...
|Command | Arguments |  Description |
|:------:|:---------:|:--------------------------------------:|
|!dodaj | @korisnik | dodaj na listu cekanja |
...
|!maksimalnaduzina | X | specify the maximum length a song can be when timeguard is enabled |
|!pomeri | @korisnik (X) | pomeri korisnika na poziciju X |
|!izbaci | @korisnik | izbaci iz liste cekanja |
|!rulet | | pokreni rulet |
...
|!kadjeusao | @korisnik | shows how long the user has been in the room |
|!kik | (X) | kicks user for X minutes, default is 0.25 minutes (15 seconds) |
...
|!premotaj | | skip the current song |
...
|!sajt | | links to the room's website (if set in the settings) |
